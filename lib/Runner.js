...
var Runner = ( () => {
    ...
    class Func {
        ...
        callFunc (args,_scope) {
            ...
            switch (this.func_type) {
                case "normal":
                    ...
                    break;
                case "built-in":
                    this.callBuiltInFunction(args,_scope);
                    break;
                default :
        ...
        callBuiltInFunction (args,_scope) {
            if(this.canCallFunction(args.length)) this.callee(...args,_scope);
        }
    }
    ...
    function execute_container (tree) {
        switch (tree.type) {
            ...
            default :
                ...
                if(tree.hasAttrs(["CALLBACK"])) {
                    let InstantFunctionCallback = new Func("normal",tree,_Array.unwrapALLvalues([]));
                    InstantFunctionCallback.callFunc([],tree.scope); // callback
                }
        }
    }
